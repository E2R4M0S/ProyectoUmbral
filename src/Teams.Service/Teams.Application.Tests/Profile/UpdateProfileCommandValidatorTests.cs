...
public class UpdateProfileCommandValidatorTests
{
    ...
    public void Validate_ShouldReturnExpectedResult(string name, string alias, bool expectedValid)
    {
        // Arrange
        var command = new UpdateProfileCommand(name, alias, "kc-user-123");
    ...
    public void Validate_ShouldFail_WhenNameExceeds100Characters()
    {
        ...
        var command = new UpdateProfileCommand(name101, "johnny", "kc-user-123");
