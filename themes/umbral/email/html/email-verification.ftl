  ...
  <table width="100%" style="max-width:520px;">
    ...
    <tr>
      <td style="background-color:#16213e;border-radius:12px;padding:36px 32px;text-align:center;">
        <h1 style="color:#ffffff;font-size:22px;margin:0 0 16px 0;">Verific&aacute; tu correo</h1>
        <p style="color:#b0b0b0;font-size:15px;line-height:1.6;margin:0 0 28px 0;">
          ...
          Gracias por registrarte en <strong style="color:#e94560;">UMBRAL</strong>.
          Para activar tu cuenta, hac&eacute; clic en el bot&oacute;n de abajo.
        </p>
        ...
        <p style="color:#666;font-size:13px;margin:24px 0 0 0;line-height:1.5;">
          ...
          Si no creaste esta cuenta, ignor&aacute; este mensaje.
        </p>
      </td>
    </tr>
    <tr>
